...
import { Container, Breadcrumb, Button, Alert, Table } from "react-bootstrap";
import { LogContext } from "../../../context/context";
import { Link } from "react-router-dom";
import Moment from "react-moment";

const ViewLecturerRooms = ({}) => {
  const { lecturerRooms, deleteLecturerRoom, alert } = useContext(LogContext);

  return (
    <>
      <Breadcrumb>
        <Breadcrumb.Item href="/">Home</Breadcrumb.Item>
        <Breadcrumb.Item active>View Lecturer-Rooms</Breadcrumb.Item>
      </Breadcrumb>
      <Container>
        <Table>
          <thead>
...
export default ViewLecturerRooms;
