...
const ViewSubjectRooms = ({}) => {
  const { sortedSubjects, subjectRooms, deleteSubjectRoom } = useContext(
    LogContext
  );
  return (
    <>
      <Breadcrumb>
        ...
        <Breadcrumb.Item active>View Subject-Rooms</Breadcrumb.Item>
      </Breadcrumb>
      <Container>
        <Table>
          <thead>
...
export default ViewSubjectRooms;
